...
**Islam Magdy <i.magdy.m@icloud.com>**
...
- Homebrew taps
- npm packages
- Docker or container registries
- Social accounts
- Documentation sites
...
The maintainers may approve community merchandise on a case-by-case basis.
...
The maintainers may request changes, clarification, renaming, removal, or other action to avoid user confusion.
...
To request permission, open an issue or contact the maintainers through the official project channels.
...
- Where the use will appear
- How users will know whether it is official or independent

## 14. Changes to this policy

The maintainers may update this policy over time.
